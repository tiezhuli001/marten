...
- task_id: 95468ed8-2e74-49f1-a916-f9cc51af9a11
- issue_number: 37
- branch: codex/issue-37-sleep-coding

## Summary
Implement Issue #37: [Main Agent] 请创建一个用于 MVP 全链路验证的 docs 任务，要求只新增文档验证文件，方便 Ralph 安全完成整条链路。
